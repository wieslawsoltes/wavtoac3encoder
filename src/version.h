...
#define VER_FILE_DESCRIPTION_STR    "WAV to AC3 Encoder"
...
#define VER_PRODUCTNAME_STR         "EncWAVtoAC3"
...
#define VER_COPYRIGHT_STR           "Copyright (C) 2007-2017 Wieslaw Soltes. All rights reserved."
