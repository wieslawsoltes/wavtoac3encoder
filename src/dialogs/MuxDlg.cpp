...
void CMuxDlg::InitCtrls()
{
    ...
    szTmpText = theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C01008) :
    ...
    this->m_ChkChannelConfigLFE.SetTooltipText(
        theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C01009) : _T("Indicates use of the LFE channel."));

    // set fixed height of combobox controls
    SetComboBoxHeight(this->GetSafeHwnd(), IDC_COMBO_CHANNEL_CONFIG, 15);

    // channel buttons
    this->m_BtnChannelFL.SetTooltipText(theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C0100A) : _T("Front Left Channel"));
    this->m_BtnChannelFR.SetTooltipText(theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C0100B) : _T("Front Right Channel"));
    this->m_BtnChannelFC.SetTooltipText(theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C0100C) : _T("Front Center Channel"));
    this->m_BtnChannelLFE.SetTooltipText(theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C0100D) : _T("Low Frequency Effect Channel"));
    this->m_BtnChannelSL.SetTooltipText(theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C0100E) : _T("Surround Left Channel"));
    this->m_BtnChannelSR.SetTooltipText(theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C0100F) : _T("Surround Right Channel"));
    this->m_BtnChannelS.SetTooltipText(theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C01010) : _T("Surround Channel"));
...
void CMuxDlg::InitLang()
{
    ...
    {
        this->SetWindowText(_T("WAV to AC3 Encoder - ") + theLangManager.GetLangString(0x00C01001));
        this->GetDlgItem(IDC_STATIC_TEXT_CHANNEL_CONFIG)->SetWindowText(theLangManager.GetLangString(0x00C01002));
        this->GetDlgItem(IDC_BUTTON_IMPORT)->SetWindowText(theLangManager.GetLangString(0x00C01003));
        this->GetDlgItem(IDC_BUTTON_EXPORT)->SetWindowText(theLangManager.GetLangString(0x00C01004));
        this->GetDlgItem(IDOK)->SetWindowText(theLangManager.GetLangString(0x00C01005));
        this->GetDlgItem(IDCANCEL)->SetWindowText(theLangManager.GetLangString(0x00C01006));
        this->GetDlgItem(IDC_BUTTON_CLEAR_FL)->SetWindowText(theLangManager.GetLangString(0x00C01007));
        this->GetDlgItem(IDC_BUTTON_CLEAR_FC)->SetWindowText(theLangManager.GetLangString(0x00C01007));
        this->GetDlgItem(IDC_BUTTON_CLEAR_FR)->SetWindowText(theLangManager.GetLangString(0x00C01007));
        this->GetDlgItem(IDC_BUTTON_CLEAR_LFE)->SetWindowText(theLangManager.GetLangString(0x00C01007));
        this->GetDlgItem(IDC_BUTTON_CLEAR_SL)->SetWindowText(theLangManager.GetLangString(0x00C01007));
        this->GetDlgItem(IDC_BUTTON_CLEAR_SR)->SetWindowText(theLangManager.GetLangString(0x00C01007));
    }
}
...
void CMuxDlg::OnBnClickedButtonExport()
{
    CFileDialog fd(FALSE,
        ...
        _T(""),
        OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER | OFN_ENABLESIZING,
        theLangManager.HaveLangStrings() ? theLangManager.GetLangString(0x00C01011) :
