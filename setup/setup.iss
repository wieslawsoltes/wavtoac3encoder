...
#if "x64" == ProgramBuild
    Source: {#BasePath}\engines\unicode\Win64\EncWAVtoAC3.engines; DestDir: {userappdata}\EncWAVtoAC3-AMD64; Flags: ignoreversion uninsneveruninstall; Components: config
...
#else
    Source: {#BasePath}\engines\unicode\Win32\EncWAVtoAC3.engines; DestDir: {userappdata}\EncWAVtoAC3; Flags: ignoreversion uninsneveruninstall; Components: config
