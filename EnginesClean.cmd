...
rmdir /S /Q "%BasePath%\libaftendll_AMD6_SSE"
rmdir /S /Q "%BasePath%\libaftendll_AMD6_SSE2"
rmdir /S /Q "%BasePath%\libaftendll_AMD6_SSE3"
del "%BasePath%\%EnginesFileName%"

set BasePath=Release\x64
rmdir /S /Q "%BasePath%\libaftendll_AMD6"
rmdir /S /Q "%BasePath%\libaftendll_AMD6_SSE"
rmdir /S /Q "%BasePath%\libaftendll_AMD6_SSE2"
rmdir /S /Q "%BasePath%\libaftendll_AMD6_SSE3"
del "%BasePath%\%EnginesFileName%"
