;
; WAV to AC3 Encoder
; Copyright (C) 2007-2013 Wieslaw Soltes <wieslaw.soltes@gmail.com>
;
...
Source: ..\engines\unicode\Win32\EncWAVtoAC3.engines; DestDir: {userappdata}\EncWAVtoAC3; Flags: ignoreversion
